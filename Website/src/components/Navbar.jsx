...
function Navbar() {
    ...
    return (
        <div>
            <nav className="flex items-center justify-between flex-wrap fixed top-0 lg:h-24 z-40 w-full backdrop-blur flex-none transition-colors duration-500 bg-blur bg-customGray/60 dark:bg-customGray/80 text-white border-b border-gray-700  ">
