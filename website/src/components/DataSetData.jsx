        ...
        datasets: [
          {
            ...
            path: 'https://github.com/neokd/DataBucket/blob/main/DataBucket/CSE_ABBV.json',
            contributor: 'neokd',
            added: '27-05-2023',
            updated: '27-05-2023',
            size: '3.37KB',
          ...
          },
          {
            ...
            path: 'https://github.com/neokd/DataBucket/blob/main/DataBucket/CSE_AV.json',
            contributor: 'neokd',
            added: '27-05-2023',
            updated: '27-05-2023',
            size: '3.37KB',
        ...
        datasets: [
          {
            ...
            path: 'https://github.com/neokd/DataBucket/blob/main/DataBucket/stock_market_data.json',
            contributor: 'neokd',
            added: '27-05-2023',
            updated: '27-05-2023',
            size: '5.82MB',
          ...
          },
          {
            ...
            path: 'https://github.com/neokd/DataBucket/blob/main/DataBucket/cryptocurrency_prices.json',
            contributor: 'neokd',
            added: '27-05-2023',
            updated: '27-05-2023',
            size: '1.24MB',
